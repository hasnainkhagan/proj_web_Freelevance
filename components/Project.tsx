        ...
        <div className="w-[49%]" key={item.id}>
          ...
          <div className="flex items-center gap-[10px] mt-[20px] flex-wrap">
            {item.links.map((link: any) => (
              ...
              >
                <Link
                  className="text-[18px] leading-[18px] font-NeueMontreal text-white uppercase group-hover:text-secondary transition-all duration-300 ease-in-out hover:text-secondary"
                  href={link.href}
                >
        ...
        <div className="flex items-center justify-between bg-white cursor-pointer rounded-full group">
          ...
          >
            <Rounded className="py-[10px]" backgroundColor="#000">
              ...
              <div className="bg-secondary p-[15px] rounded-full scale-[0.3] mr-[17px] group-hover:scale-[1] transition-all z-10 text-secondary group-hover:bg-white  duration-300 ease-in-out">
