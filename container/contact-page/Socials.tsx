...
export default function Socials() {
  ...
  const phrase = ["INSTAGRAM", "Discord", "facebook", "linkedin"];
  useEffect(() => {
    ...
    >
      <div className="w-full h-full flex justify-center gap-[50px] items-center flex-col">
        <div className="flex flex-col gap-[10px] pb-[50px]">
          <h1 className="text-[277px] leading-[207px] lg:text-[230px] lg:leading-[170px] md:text-[150px] md:leading-[100px] sm:text-[74px] sm:leading-[68px] xm:text-[64px] xm:leading-[48px] text-center font-bold font-FoundersGrotesk text-secondary uppercase pointer-events-none">
