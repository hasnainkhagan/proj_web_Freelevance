          ...
          <div className="w-full flex items-center justify-between py-[10px] padding-x">
            <div className="w-[50%] flex items-center">
              <div className="w-[40%] sm:w-auto xm:w-auto">
                <Link
                  href={item.href}
                  className="small-text font-normal font-NeueMontreal text-secondary link-flash"
                >
                  {item.website}
                </Link>
              </div>
              <div className="w-auto sm:hidden xm:hidden">
                <motion.h3
                  className={`small-text font-normal font-NeueMontreal text-secondary ${
            ...
            <div className="w-[50%] flex justify-between items-center">
              <div className="w-[40%] sm:w-auto xm:w-auto">
                <h3 className="small-text font-normal font-NeueMontreal text-secondary">
                  {item.name}
                </h3>
              </div>
                ...
                {activeAccordion === item.id && (
                  ...
                  >
                    <div className="flex flex-col gap-[20px] py-[30px]">
                      ...
                      <div className="">
                        <p className="small-text tracking-wider font-normal font-NeueMontreal text-secondary">
                          {item.review}
                        </p>
                      </div>
                    </div>
